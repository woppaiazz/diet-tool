...
def BMR():
    ...
    protein = ['Soya(1 cup)','Daging Matang(3 Ons)','Cooked fish(4 Oz)','1 whole egg + 4 egg whites','Tofu(5 Oz)']
    fruit = ['Bluberry(80 Ons)','Apel','Jeruk','Pisang','Buah Kering(Segenggam)','Jus Buah(125ml)']
...
l1 = Label(a, text='Berat')
l2 = Label(a, text='Tinggi(cm)')
l3 = Label(a, text='Umur  ')
l4 = Label(a, text = 'Jenis Kelamin', bg = 'blue')
l5 = Label(a, text = 'Aktivitas', bg = 'blue')
l7 = Label(a, text = '')
